...
type (
	prefixParseFn func() ast.Expression               // function that returns a prefix Expression
	infixParseFn  func(ast.Expression) ast.Expression // function that returns an infix Expression
)
...
func (p *Parser) parseIntegerLiteral() ast.Expression {
	...
	value, err := strconv.ParseInt(p.curToken.Literal, 0, 64) //64 bit integer
	if err != nil {
...
func (p *Parser) parseFloatLiteral() ast.Expression {
	...
	value, err := strconv.ParseFloat(p.curToken.Literal, 64) //64 bit float
	if err != nil {
...
// parses both if and else statement
